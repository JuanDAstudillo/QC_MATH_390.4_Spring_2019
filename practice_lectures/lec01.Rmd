...
rep(1, 10)
rep(c(1, 2, 3), 10)
rep(seq(1, 2, by = 0.1), 7)## this will repeat the sequence 7 times 
...
as.numeric(x)
sum(x) #does the numeric conversion for you // where true =1 and false = 0
...
sample(x)
sample(x, 3)
sample(x, 101)##here im not remplacing it so I can not take 101 because only 100
