...
mpg$trans[str_detect(mpg$trans, "auto") ] <- "automatic"
table(mpg$trans)
...
ggplot(mpg, aes(x = cty, y = trans)) +
  geom_density(fill = "green", alpha = 0.3, col = "white") +
  labs(title = "Transmision Displacement Dencity" , subtitle = "", x = "City (mpg)", y = "Transmision", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
ggplot(mpg, aes(x = trans, y = cty )) +
  geom_boxplot() + 
  labs(title = "City Fuel Efficiency by transmission" , subtitle = "", y = "City (mpg)", x = "Transmision", caption = "Source: EPA 2008 Fuel Economy Dataset")
```
...
ggplot(mpg, aes(x = drv, y = cty )) +
  geom_boxplot() + 
  facet_grid(mpg$trans, scales = "free") +
  labs(title = "City Fuel Efficiency by All Wheel Drive" , subtitle = "Whith Transmission's Type", y = "City (mpg)", x = "AWD", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
ggplot(mpg, aes(x = trans , y = "", fill = class)) +
  ...
  coord_polar("x", start = 0) +
    labs(title = "Class by Transmission Type Pie Chart" , subtitle = "", x = " ", y = " ", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
d = ggplot(mpg, aes(x = year,  y = hwy)) +
      geom_point() +
labs(title = "City Fuel Efficiency by Year", x = "Year", y = "City (mpg)", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
dat = data.frame(y,x)
ggplot(dat) + 
  geom_point(aes(x,y), color = "green")+
  stat_function(fun = function(x){y = x^2}, color = "red" )
```
...
cppFunction('
  unsigned  long long int fun_cpp(int n){
